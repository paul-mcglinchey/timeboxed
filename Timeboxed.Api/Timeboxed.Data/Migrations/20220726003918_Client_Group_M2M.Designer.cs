...
namespace Timeboxed.Data.Migrations
{
    ...
    [Migration("20220726003918_Client_Group_M2M")]
    partial class Client_Group_M2M
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.Common.ContactInfo", b =>
                {
                    ...
                    b.Property<Guid>("PrimaryPhoneNumberId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PrimaryPhoneNumberId");
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.Common.ContactInfo", b =>
                {
                    b.HasOne("Tiebreaker.Domain.Models.Common.Email", "PrimaryEmailAddress")
                        .WithMany()
                        .HasForeignKey("PrimaryEmailAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tiebreaker.Domain.Models.Common.PhoneNumber", "PrimaryPhoneNumber")
                        .WithMany()
                        .HasForeignKey("PrimaryPhoneNumberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
