...
namespace Timeboxed.Data.Migrations
{
    ...
    [Migration("20220815001443_Update_RotaEmployees_FKs")]
    partial class Update_RotaEmployees_FKs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.UserPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.EmployeePreferences", b =>
                {
                    b.HasOne("Tiebreaker.Domain.Models.Employee", null)
                        .WithOne("Preferences")
                        .HasForeignKey("Tiebreaker.Domain.Models.EmployeePreferences", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.EmployeeScheduleShift", b =>
                {
                    b.HasOne("Tiebreaker.Domain.Models.EmployeeSchedule", null)
                        .WithMany("Shifts")
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.UserPreferences", b =>
                {
                    b.HasOne("Tiebreaker.Domain.Models.User", null)
                        .WithOne("Preferences")
                        .HasForeignKey("Tiebreaker.Domain.Models.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
