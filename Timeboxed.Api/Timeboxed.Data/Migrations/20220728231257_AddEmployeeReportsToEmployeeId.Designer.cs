...
namespace Timeboxed.Data.Migrations
{
    ...
    [Migration("20220728231257_AddEmployeeReportsToEmployeeId")]
    partial class AddEmployeeReportsToEmployeeId
    {
            ...
            modelBuilder.Entity("Tiebreaker.Domain.Models.Employee", b =>
                {
                    ...
                    b.HasOne("Tiebreaker.Domain.Models.Employee", "ReportsTo")
                        .WithMany()
