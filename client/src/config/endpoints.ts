...
export const endpoints = {
    ...
    systemlistcollection: (listcollectionId: string) => DOTNET_API_URL + `listcollections/system/${listcollectionId}`,
    systemlistcollections: DOTNET_API_URL + "listcollections/system",
