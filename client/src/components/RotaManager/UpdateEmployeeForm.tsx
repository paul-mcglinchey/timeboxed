...
import { CustomDate, FormSection, FormikInput, ListboxSelector, SpinnerLoader } from "../Common";
...
const UpdateEmployeeForm = ({ employee, ContextualSubmissionButton }: IUpdateEmployeeFormProps & IContextualFormProps) => {
  ...
  const { employees, getEmployee, updateEmployee } = useEmployeeService(setIsLoading, setError)
