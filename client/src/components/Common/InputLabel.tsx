  ...
  return (
    <label
      ...
      className={combineClassNames(
        ...
        visibilityConditions.every(vc => vc) && "peer-placeholder-shown:text-gray-100/60 peer-placeholder-shown:text-base peer-placeholder-shown:top-2 peer-placeholder-shown:left-3.5")}
    >
      {label}
    </label>
  )
