...
const UpdateClientForm = ({ client, ContextualSubmissionButton }: IUpdateClientFormProps & IContextualFormProps) => {
  ...
  return (
    <Formik
      initialValues={{
        ...
        middleNames: client.middleNames || null,
        ...
        primaryPhoneNumber: client.primaryPhoneNumber || null,
